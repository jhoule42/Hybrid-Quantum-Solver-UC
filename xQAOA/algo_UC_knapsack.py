...
for D in range_D:
    ...
    # optimizer_X.parameter_optimization([15], [0], N_beta=15, N_gamma=15, bit_mapping='inverse')
    ...
    # print(f"UC cost: {cost}")
    # print(f"Power Load: {power:.1f}/{L}")
...
results_quantum = extract_quantum_results(list_cost, list_power, list_zi, list_p_i, range_D)
...
print(f"Optimal D: {results_quantum['optimal_D']:.2f}")
