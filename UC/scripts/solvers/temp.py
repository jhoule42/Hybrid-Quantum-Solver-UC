...
class ADMMOptimizer(OptimizationAlgorithm):
    ...
    **References:**
    ...
    def __init__(
        ...
        # TODO Make it possible to give the backend and pass manager as an argument
    ...
    def solve(self, problem: QuadraticProgram) -> ADMMOptimizationResult:
        ...
        x0_params[1::2] = self._params.betas0 # betas        
    ...
    def _create_qubo(self, update_power=None, lambda1=1000) -> QuadraticProgram:
        ...
        qp = cross_terms_matrix(self._state.op, lambda1, p_min, p_max, L)
